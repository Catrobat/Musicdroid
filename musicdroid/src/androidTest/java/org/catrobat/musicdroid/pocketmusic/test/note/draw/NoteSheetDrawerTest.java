...
public class NoteSheetDrawerTest extends AbstractDrawerTest {
    ...
    public void testDrawLines() {
        ...
        for (int i = noteSheetDrawer.getYPositionOfBarTop(); i <= noteSheetDrawer.getYPositionOfBarBottom(); i += noteSheetDrawer.getDistanceBetweenLines()) {
            assertCanvasElementQueueLine(drawPosition.getStartXPositionForNextElement(), i, drawPosition.getEndXPositionForDrawingElements(), i, paint);
        }
    }
    ...
    public void testDrawBars() {
        ...
        assertCanvasElementQueueRect(drawPosition.getStartXPositionForNextElement(), noteSheetDrawer.getYPositionOfBarTop(), drawPosition.getStartXPositionForNextElement() + NoteSheetDrawer.BOLD_BAR_WIDTH, noteSheetDrawer.getYPositionOfBarBottom(), paint);
        assertCanvasElementQueueRect(drawPosition.getEndXPositionForDrawingElements() - NoteSheetDrawer.BOLD_BAR_WIDTH, noteSheetDrawer.getYPositionOfBarTop(), drawPosition.getEndXPositionForDrawingElements(), noteSheetDrawer.getYPositionOfBarBottom(), paint);
    }
    ...
    public void testDrawKey() {
        ...
        assertCanvasElementQueueBitmap(R.drawable.violine, expectedHeight, drawPosition.getStartXPositionForNextElement(), noteSheetCanvas.getHeightHalf(), paint);
    }
