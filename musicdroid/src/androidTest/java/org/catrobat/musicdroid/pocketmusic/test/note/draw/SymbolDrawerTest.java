...
public class SymbolDrawerTest extends AbstractDrawerTest {
    ...
    protected void setUp() {
        ...
        symbolDrawer = new SymbolDrawerMock(noteSheetCanvas, new Paint(), getContext().getResources(), MusicalKey.VIOLIN, drawPosition,DISTANCE_BETWEEN_LINES);
    }
    ...
    private class SymbolDrawerMock extends SymbolDrawer {
