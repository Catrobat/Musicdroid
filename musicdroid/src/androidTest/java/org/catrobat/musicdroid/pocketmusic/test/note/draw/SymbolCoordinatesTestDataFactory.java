...
public class SymbolCoordinatesTestDataFactory {

    private SymbolCoordinatesTestDataFactory() {}

    public static SymbolCoordinates createSymbolCoordinates() {
        return createSymbolCoordinates(new RectF(0, 100, 200, 0));
    }
