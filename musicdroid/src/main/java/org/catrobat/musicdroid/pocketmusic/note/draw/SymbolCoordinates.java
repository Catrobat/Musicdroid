...
public class SymbolCoordinates {
    ...
    public boolean equals(Object obj) {
        if ((obj == null) || !(obj instanceof SymbolCoordinates)) {
            return false;
        }

        SymbolCoordinates symbolCoordinates = (SymbolCoordinates) obj;

        if ((symbolCoordinates.getLeft() == getLeft()) &&
                (symbolCoordinates.getTop() == getTop()) &&
                (symbolCoordinates.getRight() == getRight()) &&
                (symbolCoordinates.getBottom() == getBottom())) {
            return true;
        }
